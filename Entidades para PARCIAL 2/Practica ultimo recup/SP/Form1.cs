...
namespace SP
{
    ...
    public partial class frmRSP : Form
    {
        ...
        private void btnPunto2_Click(object sender, EventArgs e)
        {
            ...
            this._bp = bp;
            this._bm = bm;
            //MessageBox.Show(this._bn.nombre + "-" + this._bp.nombre + "-" + this._bm.nombre);
        }
        ...
        private void btnPunto4_Click(object sender, EventArgs e)
        {
            ...
            if (dh.Xml("serializacionDeposito.xml"))
            {
            ...
            if (((IDeserializar)dh).Xml("serializacionDeposito.xml", out aux))
            {
        ...
        private void btnPunto5_Click(object sender, EventArgs e)
        {
            ...
            catch (MiException ex)
            {
                ...
                StreamWriter escribe = new StreamWriter("ArchivoTextoBurbujeo.txt", true);
            ...
            finally
            {
                ...
                StreamReader leyendo = new StreamReader("ArchivoTextoBurbujeo.txt");
                string contenido = leyendo.ReadToEnd();
                leyendo.Close();
        ...
        private void btnPunto7_Click(object sender, EventArgs e)
        {
            ...
            ef.ElementosParesEvent += new DelegadoEntidadesF(ManejadorPares);
            ef1.ElementosParesEvent += new DelegadoEntidadesF(ManejadorPares);
